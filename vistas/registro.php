    ...
    <div class="container reg" id="advanced-search-form">
            ...
            <form>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Apellido Paterno" id="first-name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Nombre (s)" id="name">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Numero Telefonico" id="numero">
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-info btn-lg btn-responsive" id="search"> <span class="glyphicon glyphicon-search"></span> Registrarse</button>
            </form>
        </div>
</section>      
