			...
			<div class="row">
				<div class="col-lg-12" style="display:flex; align-items:center">
					...
					<div class="block">
						<!-- Coundown Timer -->
						<div class="timer"></div>
						<h1 style="font-size:30px;">Doctorado por el CINVESTAV</h1>
						<h2>Carlos Alberto Hernández Gutiérrez</h2>
						
					</div>
					<div>
						<img style="width:476px; background:#f3f3f3; border-radius:50%" class="img-fluid" src="assets/img/Carlos Alberto Hernández Gutiérrez.jpg" alt="">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 align-self-center">
					<div class="image-block bg-about">
						<img style="width:255px; background:#f3f3f3;" class="img-fluid" src="assets/img/Carlos Alberto Hernández Gutiérrez.jpg" alt="">
					</div>
				</div>
				<div class="col-lg-8 col-md-6 align-self-center" style="text-align:justify;">
					<div class="content-block">
						<h2>Acerca del <span class="alternate">Dr. Carlos Hernández</span></h2>						
						<div class="description-two">
							<p>
								El Dr. Carlos Hernández realizó sus estudios de Maestría y Doctorado en el CINVESTAV ZACATENCO. Posteriormente realizó una estancia posdoctoral en la universidad de Texas en Dallas. Actualmente trabaja como profesor investigador de tiempo completo para el TECNM campus ITTG. Su línea de investigación se centra en las celdas solares y nanoestructuras. 
							</p>
						</div>				
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8 col-md-6 align-self-center">
					<div class="content-block">
						<h3>Conferencia <br><span class="alternate" style="font-size:28px;">"Investigación de UVC LEDs contra el COVID-19"</span></h3>
						...
						<div class="description-two">
							<p>
								Se expondrán los modelos matemáticos y físicos fundamentales para la fabricación de LEDs que emitan en el rango UVC para deshinfeción.
							</p>
						</div>
						<div class="description-two">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					...
					<div class="speaker-item" style="box-shadow: 0 0 40px yellow;">
						...
						<div class="content text-center">
							<h5><a style="color:#e11344">Carlos Alberto Hernández Gutiérrez</a></h5>
